...
const Score = ({portfolio,entries,rank} : any) => {
          ...
          <div className=' h-16 w-92 m-4 justify-between shadow-md flex bg-white rounded-md items-center'>
            ...
            <div className='m-4 '>
                ...
                <div className='text-xs text-dark-text'>
                    <span className=''>
                        {instrumentname.get(portfolio.instrument1)}({portfolio.booster1}),  {instrumentname.get(portfolio.instrument2)}({portfolio.booster2}),
                        <br/>
                        {instrumentname.get(portfolio.instrument3)}({portfolio.booster3}),  {instrumentname.get(portfolio.instrument4)}({portfolio.booster4})
                    </span>
                </div>
            </div>
